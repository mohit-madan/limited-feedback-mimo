...
\begin{figure}
\begin{center}
\includegraphics[width=0.8\columnwidth]{images/new-adpm.pdf}
...
$N_{R}(2N_{T} - 1) - N_R^2 = 10$, with five $\theta_l$s and and seven
...
\begin{figure}
\begin{center}
\includegraphics[width=0.72\columnwidth]{images/1024final_withtime}
...
better than the previous case. Naturally, the rate of channel
variation is quite fast, which limits the efficacy of the proposed
method in tracking the channel parameters.
\begin{figure}
\begin{center}
\includegraphics[width=0.72\columnwidth]{images/64final_withtime}
