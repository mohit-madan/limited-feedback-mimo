...
Equation~\ref{delta_eqn}, with $M = 1.4$ (the choice is motivated by
the results in~\cite{5671092}), and track parameters with the temporal
evolution of the channel, and we find that this choice effectively
tracks the channel parameters.
