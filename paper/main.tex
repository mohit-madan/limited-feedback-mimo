...
\begin{figure}
\begin{center}
\includegraphics[width=0.78\columnwidth]{images/1024final_withtime}
...
quantization by about 1 dB for higher SNRs. Naturally, the rate of
channel variation is quite fast, which limits the efficacy of the
proposed method in tracking the channel parameters.
\begin{figure}
\begin{center}
\includegraphics[width=0.78\columnwidth]{images/64final_withtime}
