...
def main():
    ...
    for chan_index in range(num_chan_realisations):
        ...
        onlyt_allU_vec=np.zeros((number_simulations,num_subcarriers,2*Nt*Nr-Nr**2))
        ...
        onlyt_del_vec=np.zeros((number_simulations,feedback_mats,2*Nt*Nr-Nr**2))
        onlyt_beta_vec=np.zeros((number_simulations, feedback_mats, 2*Nt*Nr-Nr**2))
